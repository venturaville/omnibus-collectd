...
source :url => "http://www.percona.com/redir/downloads/Percona-Server-5.5/Percona-Server-5.5.33-31.1/binary/linux/x86_64/Percona-Server-5.5.33-rel31.1-566.Linux.x86_64.tar.gz",
